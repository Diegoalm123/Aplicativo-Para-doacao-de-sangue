...
public class CadastrarTelaView extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        txtNascimento.setHorizontalAlignment(javax.swing.JTextField.LEFT);
        getContentPane().add(txtNascimento, new org.netbeans.lib.awtextra.AbsoluteConstraints(270, 140, 140, 30));

        lblId1.setFont(new java.awt.Font("Arial", 3, 24)); // NOI18N
        ...
        lblId2.setFont(new java.awt.Font("Arial", 3, 24)); // NOI18N
        ...
        txtGenero.setFont(new java.awt.Font("Arial", 3, 14)); // NOI18N
        txtGenero.setForeground(new java.awt.Color(0, 0, 0));
        txtGenero.setHorizontalAlignment(javax.swing.JTextField.LEFT);
        ...
        txtEstadoCivil.setFont(new java.awt.Font("Arial", 3, 14)); // NOI18N
        ...
        lblId4.setFont(new java.awt.Font("Arial", 3, 24)); // NOI18N
        ...
        lblId5.setFont(new java.awt.Font("Arial", 3, 24)); // NOI18N
        lblId5.setForeground(new java.awt.Color(0, 0, 0));
        ...
        Nome.setFont(new java.awt.Font("Arial", 3, 24)); // NOI18N
        ...
        txtNomeCompleto.setFont(new java.awt.Font("Arial", 3, 14)); // NOI18N
        ...
        lblId6.setFont(new java.awt.Font("Arial", 3, 24)); // NOI18N
        lblId6.setForeground(new java.awt.Color(0, 0, 0));
        ...
        txtSangue.setFont(new java.awt.Font("Arial", 3, 14)); // NOI18N
        txtSangue.setForeground(new java.awt.Color(0, 0, 0));
        txtSangue.setHorizontalAlignment(javax.swing.JTextField.LEFT);
        ...
        getContentPane().add(Cadastrar, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 290, 70, -1));
        ...
        getContentPane().add(Cadastrar1, new org.netbeans.lib.awtextra.AbsoluteConstraints(130, 290, -1, -1));

        fundo.setIcon(new javax.swing.ImageIcon(getClass().getResource("/images/cadastro tel 3.png"))); // NOI18N
        getContentPane().add(fundo, new org.netbeans.lib.awtextra.AbsoluteConstraints(-4, 0, 740, 320));
